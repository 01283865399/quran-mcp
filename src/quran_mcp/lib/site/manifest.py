...
routes: dict[str, dict[str, dict[str, Any]]] = {
    ...
    "pages": {
        ...
        "/adhkar": {"file": asset_path("landing.html"), "headers": {"Cache-Control": "no-store"}},
        "/tasbih": {"file": asset_path("landing.html"), "headers": {"Cache-Control": "no-store"}},
        "/mushaf": {"file": asset_path("landing.html"), "headers": {"Cache-Control": "no-store"}},
        "/translations": {"file": asset_path("landing.html"), "headers": {"Cache-Control": "no-store"}},
        "/about": {"file": asset_path("about.html"), "headers": {"Cache-Control": "no-store"}},
        "/contact": {"file": asset_path("contact.html"), "headers": {"Cache-Control": "no-store"}},
