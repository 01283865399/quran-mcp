...
<div class="container" use:initCollapsibles>
  ...
  <nav class="top-nav">
    ...
    <div class="nav-meta">المالك وصانع الموقع: أحمد ديب</div>
  ...
  <div class="card url-card">
    ...
    <p>
      يمكنك ربط هذا الخادم بأي عميل AI يدعم MCP، مثل <a href="#setup-claude">Claude</a> أو <a href="#setup-chatgpt">ChatGPT</a>.
      عند استدعاء الخادم، تُبنى الإجابات على بيانات موثقة من <a href="https://quran.com">quran.com</a>، بعيداً عن التخمين أو التقدير.
    </p>
  </div>
